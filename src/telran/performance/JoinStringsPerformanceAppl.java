...
public class JoinStringsPerformanceAppl {
	...
	public static void main(String[] args) {
		...
		PerformanceTest onStandardTest = getTest("JoinStringsOnStandard", strings, new JoinStringsOnStandart());
		PerformanceTest onStringTest = getTest("JoinStringsOnString", strings, new JoinStringsOnStrings());
